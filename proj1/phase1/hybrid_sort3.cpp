...
void HybridSort3::hybrid_sort3(std::vector<int>& nums) noexcept
{
...
void HybridSort3::recur(std::vector<int>& nums, int left, int right, int H) noexcept
{
...
void HybridSort3::merge(std::vector<int>& nums, int left, int middle, int right) noexcept
{
...
void HybridSort3::insertion_sort(std::vector<int>& nums, int left, int right) noexcept
{
